...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 06 oct. 2022 à 07:19
...
(19, 'hgfhgf', 2053, '<p>ghfhgxfdcghfch</p>', '', '2022-10-05', 18, 'blog', 18);
...
CREATE TABLE `commentaire` (
  `id` int(11) NOT NULL,
  `titrecom` varchar(255) DEFAULT NULL,
  `textecom` varchar(2500) DEFAULT NULL,
  `id_1` int(11) NOT NULL,
...
INSERT INTO `commentaire` (`id`, `titrecom`, `textecom`, `id_1`, `id_2`) VALUES
(1, 'test', 'test', 18, 18),
(12, 'bcgvhbcg', 'cbcvbvc', 18, 18),
(31, 'cxvcxvcx', 'cxvxcvdfdsf', 18, 16),
(34, 'cxvcxvvcbc', 'cvxvcxbvcbvc', 18, 16),
(35, 'cbvcb', 'vbcbc', 18, 17),
(36, 'fgdfg', 'fdgfdg', 18, 17),
(37, 'vbcb', 'vbcvb', 18, 19);
